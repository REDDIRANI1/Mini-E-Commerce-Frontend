...
export default function ProductsPage() {
  ...
  const { filters, setFilters, sortOption, searchQuery, setSearchQuery, debouncedSearchQuery } = useFilter();
          ...
          <div className="flex flex-col">
            ...
            <div className="text-sm text-muted-foreground flex items-center flex-wrap gap-2">
              ...
              {Object.entries(filters).map(([key, value]) => {
                ...
                return (
                  <span key={key} className="inline-flex items-center bg-secondary text-secondary-foreground rounded-full px-2 py-1 text-xs">
